...
public class GroupChatAdapter extends BaseAdapter implements SectionIndexer{
	...
	public GroupChatAdapter(Context context, List<Contact> list) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.item_groupchat_lv, null);
			honder.zimuTv = (TextView) convertView.findViewById(R.id.groupchat_lv_zimu);
			honder.nameTV = (TextView) convertView.findViewById(R.id.groupchat_lv_name);
			honder.headIv = (RoundImageView) convertView.findViewById(R.id.groupchat_lv_head);
			honder.chexbox = (CheckBox) convertView.findViewById(R.id.groupchat_lv_check);
		...
		honder.chexbox.setChecked(contact.isCheck());
